...
exports.captureScreenshot = async (req, res) => {
    ...
    try {
        ...
        if (device === 'mobile' || isMobile === 'true') {
            ...
            viewportHeight = viewportHeight || 1366;
        ...
        } else if (device === 'iphone-14-pro-max') {
            // iPhone 14 Pro Max - Inspect Mode (414 x 736 as per user request, typically 430x932)
            viewportWidth = viewportWidth || 414;
            viewportHeight = viewportHeight || 736;
        ...
        } else if (device === 'safari-desktop') {
            // Desktop Safari 18 (macOS Sequoia – 1440 × 900)
            viewportWidth = viewportWidth || 1440;
            viewportHeight = viewportHeight || 900;
            // Fake Safari UA on macOS
        ...
        } else if (device === 'safari-tablet') {
            // Tablet – Safari (iPad Pro 12.9", 4th Gen)
            viewportWidth = viewportWidth || 1024;
            viewportHeight = viewportHeight || 1366;
        ...
        } else if (device === 'safari-mobile') {
            // Mobile – Safari (iPhone 17 Pro Max - speculative dimensions/UA)
            viewportWidth = viewportWidth || 430;
            viewportHeight = viewportHeight || 932;
...
exports.getPageContent = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: 'Failed to fetch page content', details: error.message });
    }
};
