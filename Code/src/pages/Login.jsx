...
function Login() {
  ...
  const demoCredentials = [
    { role: 'Admin', email: 'admin@g99qa.com', password: 'admin123' },
    { role: 'Manager', email: 'manager@g99qa.com', password: 'manager123' },
    { role: 'Employee', email: 'employee@g99qa.com', password: 'employee123' },
  ]
